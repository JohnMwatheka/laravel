...
<div class="container d-flex justify-content-center mt-3">
  <div class="contact-form-container col-lg-8 col-xl-6 col-sm-12">
    ...
    <form id="contact-form" action="{{ route('buy-ticket') }}" method="POST">
      ...
      <div class="row mb-3">
        <div class="col">
          <input type="text" class="form-control form-input" name="firstName" placeholder="First Name" required pattern="^[A-Za-z0-9\s]+$" title="Please enter a valid first name (letters, numbers, and spaces only).">
        </div>
        <div class="col">
          <input type="text" class="form-control form-input" name="lastName" placeholder="Last Name" required pattern="^[A-Za-z0-9\s]+$" title="Please enter a valid last name (letters, numbers, and spaces only).">
        </div>
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        <input type="text" class="form-control form-input" name="school" placeholder="School" required pattern="^[A-Za-z0-9\s\-.,&']+$" title="Please enter a valid school name (letters, numbers, spaces, and common punctuation).">
      </div>
